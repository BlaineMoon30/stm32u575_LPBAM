...
/**
  **********************************************************************************************************************
  * @file   lpbam_txapp_config.c
  * @author MCD Application Team
  * @brief  Provides LPBAM TXApp application configuration services
  **********************************************************************************************************************
  * @attention
  *
...
/* Exported functions ------------------------------------------------------------------------------------------------*/
/**
  * @brief  TXApp application initialization
  * @param  None
  * @retval None
  */
void MX_TXApp_Init(void)
{
  /* USER CODE BEGIN TXApp_Init 0 */

  /* USER CODE END TXApp_Init 0 */
  ...
  /* USER CODE BEGIN TXApp_Init 1 */

  /* USER CODE END TXApp_Init 1 */
}
